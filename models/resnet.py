"""Flagrantly lifted from PyTorch's repo, modified to use dropout"""
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, dropout=0., downsample=None):
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, dropout=0., zero_init_residual=False):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dropout=0.):
        ...
        layers = []
        layers.append(block(self.inplanes, planes, stride=stride, downsample=downsample, dropout=dropout))
