...
model_args.update(bn=args.bn, classes=classes, bias=args.bias,
                  kernel_size=args.kernel_size, tanh=args.tanh,
...
tikhonov_penalty = L2Weights(model, bias=False, others=True, weight=True)
...
optimizer = optim.SGD(pmodel.parameters(),
                  lr = args.lr,
